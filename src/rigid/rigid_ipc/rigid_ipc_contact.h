...
// Contact detection for Rigid-IPC.
//
// Reuses ABD-IPC's brute-force and EFContactDetector backends, adapted
// to the 6-DOF rigid body surface representation.
...
struct SurfaceData {
    ...
    std::vector<RigidJacobi> jacobi;
    std::vector<int> vert_body;
};

// ============================================================================
// Brute-force PT detection
// ============================================================================
...
// ============================================================================
// Convert EFContactDetector results to Rigid-IPC ContactPairs
// ============================================================================
